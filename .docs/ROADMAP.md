...
- **Tiến độ (15/07/2026):** **Đợt A + Đợt B đã ĐÓNG.** Đang ở **Đợt C**. Chưa chốt mục Đợt C nào để bắt đầu (Thầy chọn phiên sau). Gợi ý ưu tiên: (1) **Ghi transaction all-or-nothing** — nối tiếp Đợt A #1, chắc chắn về độ tin cậy; hoặc (2) **CRA → Vite** — nền tảng build hiện đại, dev/HMR nhanh hơn, mở đường cho các việc sau. Hai món **In/xem PDF trong app** và **Đồng bộ nhiều máy** nặng + tuỳ nhu cầu thực tế; **Tối ưu lọc** chỉ cần khi kho thật sự lớn.
