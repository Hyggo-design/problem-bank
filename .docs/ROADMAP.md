...
- ⚙️ **Tối ưu lọc khi kho lên chục nghìn bài** — *(**ĐANG LÀM từ 17/07/2026, NK36** — Thầy chốt: mục Đợt C **cuối cùng** cần làm)*. `getRootHeId` chạy cho mỗi bài × mỗi lần lọc; ở 2000 bài tức thời, chỉ cần tối ưu khi thật sự lớn.
